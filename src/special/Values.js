...
export const commonFifth = {
    goddessBlessing: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/maple-world-goddess-blessing.png"],
        "animations": ["https://media4.giphy.com/media/AV4drI0ly2fYImnP3H/giphy.gif"],
        "type": "Buff",
        "desc": "While active, increases %Damage and the stat bonuses of <tt src={http://localhost:3000/grandislibrary/class-icons/common/maple-warrior.png} tip={Maple Warrior (4th Job)}> and similar skills"
    },
    expWarrior:{
        "name": "Blitz Shield",
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/blitz-shield.png"],
    ...
    expMagician:{
        ...
        "type": "Active",
        "desc": "Use the memorized skill chosen from <tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/mind-delve.png} tip={Mind Delve (5th Job)}>",
        "details": [
    ...
    mindDelve:{
        ...
        "type": "Active",
        "desc": "When used, allows you to select 3rd - 4th job skills using the Number Keys to be cast when using <tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/unreliable-memory.png} tip={Unreliable Memory (5th Job)}>",
        "details": [
            ...
            "This skill is gained alongside and shares SP with <tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/unreliable-memory.png} tip={Unreliable Memory (5th Job)}>"
        ]
    },
    expBowman: {
        "name": "Fury of the Wild",
        "shortDesc": "MP Cost: 800, Duration: 40 sec, Max Enemies Hit: 10, Damage: 900%, Number of Attacks: 7\\nCooldown: 105 sec",
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/fury-of-the-wild.png"],
        ...
        "details": [
            "Can only be used when <tt src={http://localhost:3000/grandislibrary/class-icons/explorers/bowmaster/phoenix.png} tip={Phoenix (3rd Job - Bowmaster)}> <tt src={http://localhost:3000/grandislibrary/class-icons/explorers/marksman/frostprey.png} tip={Frostprey (3rd Job - Marksman)}> <tt src={http://localhost:3000/grandislibrary/class-icons/explorers/pathfinder/shadow-raven.png} tip={Shadow Raven (3rd Job - Pathfinder)}> is active"
        ]
    },
    expPBowman: {
        "name": "Fury of the Wild",
    ...
    expThief: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/shadow-walker.png"],
        "animations": ["https://media4.giphy.com/media/KZvjAfaZInF431yAcH/giphy.gif"],
        "type": "Buff",
        "desc": "Activate a special <tt src={http://localhost:3000/grandislibrary/class-icons/common/dark-sight.png} tip={Dark Sight}> where attacking will not cancel the buff",
        "details": [
            "Additionally increases %Final Damage added on top of <tt src={http://localhost:3000/grandislibrary/class-icons/common/advanced-dark-sight.png} tip={Advanced Dark Sight}>"
        ]
    },
    expPirate: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/pirates-banner.png"],
    ...
    phalanxCharge:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/phalanx-charge.png"],
    ...
    cygnusBlessing:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/empress-cygnuss-blessing.png", "http://localhost:3000/grandislibrary/class-icons/5th-job/transcendent-cygnuss-blessing.png"],
        ...
        "details": [
            "Skill is enhanced after Lv. 245 becoming <tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/transcendent-cygnuss-blessing.png} tip={Transcendent Cygnus's Blessing}> Transcendent Cygnus's Blessing and additionally reduces damage taken (including %Max HP attacks)"
        ]
    },
    freudsWisdom:{
        "name": "Freud's Wisdom",
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/freuds-wisdom.png"],
    ...
    resistanceInfantry:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/resistance-infantry.png"],
    ...
    defenderOfTheDemon:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/defender-of-the-demon.png"],
    ...
    otherworldGoddessBlessing:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/otherworld-goddess-blessing.png"],
    ...
    mightOfTheNova:{
        ...
        "details": [
            "Functions exactly the same as Bishop's <tt src={http://localhost:3000/grandislibrary/class-icons/explorers/bishop/heavens-door.png} tip={Heaven's Door}> Heaven's Door"
        ]
    },
    ...
    grandisGoddessBlessingLARA:{
        ...
        "animations": ["https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNWFlNWU5OTU4M2EyNWViNzEzN2I0OWFjMTJmNjAxMWNkYTBiZWYyNiZlcD12MV9pbnRlcm5hbF9naWZzX2dpZklkJmN0PWc/sBIGtjLKfdwZOLYAie/giphy.gif"],
        "type": "Buff",
        "desc": "While active, increases %Damage and %Final Damage bonus from <tt src={http://localhost:3000/grandislibrary/class-icons/anima/lara/dragon-vein-echo.png} tip={Dragon Vein Echo (3rd Job)}>"
    },
    ...
    sengokuForce:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/sengoku-force-assemble.png"],
    ...
    princessSakunoBlessing:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/princess-sakunos-blessing.png"],
    ...
    conversionOverdrive:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/conversion-overdrive.png"],
    ...
    transcendentRhinnePrayer:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/transcendent-rhinnes-prayer.png"],
        "animations": ["https://media1.giphy.com/media/1l2KreXVnPRTEZaj1k/giphy.gif"],
        "type": "Buff",
        "desc": "While active, when <tt src={http://localhost:3000/grandislibrary/class-icons/other/zero/doubletime.png} tip={Doubletime (Transcendent Skill)}> stacks, your next attack creates an additional attack",
        "details": [
            "When used, applicable skill cooldowns are reset",
            "Additionally while active, <tt src={http://localhost:3000/grandislibrary/class-icons/other/zero/doubletime.png} tip={Doubletime (Transcendent Skill)}> and <tt src={http://localhost:3000/grandislibrary/class-icons/other/zero/immune-barrier.png} tip={Immune Barrier (Beta, Lv. 165)}}> last for their maximum duration"
        ]
    },
    powerOfDestiny:{
        ...
        "type": "Buff",
        "desc": "Use the memorized skill chosen from <tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/ring-of-samsara.png} tip={Ring of Samsara (5th Job)}>",
        "details": [
            "<tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/power-of-destiny-might.png} tip={Power of Destiny - Might}> [1 - Might]: Increases %Damage",
            "<tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/power-of-destiny-perceive.png} tip={Power of Destiny - Perceive}> [2 - Perceive]: Increases %Ignore DEF",
            "<tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/power-of-destiny-boon.png} tip={Power of Destiny - Boon}> [3 - Boon]: Grants flat Attack, Magic Attack, and All Stats",
            "<tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/power-of-destiny-journey.png} tip={Power of Destiny - Journey}> [4 - Journey]: Increases %Damage to regular monsters"
        ]
    },
    ringOfSamsara:{
        ...
        "type": "Active",
        "desc": "When used, allows you to select between 4 possible buffs using the Number Keys to be cast when using <tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/power-of-destiny.png} tip={Power of Destiny (5th Job)}>",
        "details": [
            "Failing to choose a skill within 5 sec or pressing other keys will cancel this skill",
            "The selected skill is reset at 12:00 AM UTC<bp_During that time, the buff cannot be changed until after reset_>",
            "This skill is gained alongside and shares SP with <tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/power-of-destiny.png} tip={Power of Destiny (5th Job)}>"
        ]
    },
    weaponAura:{
        "name": "Weapon Aura",
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/weapon-aura.png"],
    ...
    impenetrableSkin:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/impenetrable-skin.png"],
    ...
    manaOverload:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/mana-overload.png"],
    ...
    etherealForm:{
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/ethereal-form.png"],
    ...
    guidedArrow: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/guided-arrow.png"],
    ...
    viciousShot: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/vicious-shot.png"],
    ...
    venomBurst: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/venom-burst.png"],
    ...
    lastResort: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/last-resort.png"],
    ...
    loadedDice: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/loaded-dice.png"],
        "animations": ["https://media0.giphy.com/media/3o34vbKGyVYywzT5tB/giphy.gif"],
        "type": "Buff",
        "desc": "After using this skill, the next time you use <tt src={http://localhost:3000/grandislibrary/class-icons/common/roll-of-the-dice.png} tip={Roll of the Dice}> Roll of the Dice, you'll throw an additional dice of your choosing",
        "details": [
            "[Passive]: Permanently grants flat Attack",
            "Classes without <tt src={http://localhost:3000/grandislibrary/class-icons/common/roll-of-the-dice.png} tip={Roll of the Dice}> will be given a special skill to choose their desired number"
        ]
    },
    overdrive: {
        "name": "Overdrive",
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/overdrive.png"],
    ...
    ropeLift: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/rope-lift.png"],
        "type": "Active",
    ...
    dMysticDoor: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/explorers/bishop/mystic-door.png"],
        "type": "Summon",
    ...
    dSharpEyes: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/common/sharp-eyes.png"],
        "type": "Buff",
        "desc": "",
        "details": [
            "[Passive]: Permanently grants flat All Stats",
    ...
    dHyperBody: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/explorers/dark-knight/hyper-body.png"],
        "type": "Buff",
        "desc": "",
        "details": [
            "[Passive]: Permanently grants flat All Stats",
    ...
    dCombatOrders: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/explorers/paladin/combat-orders.png"],
        "type": "Buff",
    ...
    dAdvancedBlessing: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/decent-advanced-blessing.png"],
        "type": "Passive",
        "desc": "",
        "details": [
            "[Passive]: Permanently grants flat All Stats",
            "Does not stack with <tt src={http://localhost:3000/grandislibrary/class-icons/explorers/bishop/bless.png} tip={Bless (Bishop, 2nd Job)}> or <tt src={http://localhost:3000/grandislibrary/class-icons/explorers/bishop/advanced-blessing.png} tip={Advanced Blessing (Bishop, 4th Job)}>"
        ]
    },
    dSpeedInfusion: {
        "name": "Decent Advanced Blessing",
        "shortDesc": "Attack Speed +1 Level\\n[Passive Effect - All Stats: +6]",
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/decent-speed-infusion.png"],
        "type": "Passive",
        "desc": "",
        "details": [
            "[Passive]: Permanently grants flat All Stats",
            "Does not stack with <tt src={http://localhost:3000/grandislibrary/class-icons/common/speed-infusion.png} tip={Speed Infusion (Pirate, 4th Job)}>"
        ]
    },
    blink: {
        "name": "Blink",
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/blink.png"],
        "type": "Active",
    ...
    erdaNova: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/erda-nova.png"],
        "type": "Bind Attack",
    ...
    willOfErda: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/will-of-erda.png"],
        "type": "Buff",
    ...
    dHolySymbol: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/explorers/bishop/holy-symbol.png"],
        "type": "Buff",
        "desc": "Increases the amount of EXP gained from enemies",
        "details": [
            "Does not stack with <tt src={http://localhost:3000/grandislibrary/class-icons/explorers/bishop/holy-symbol.png} tip={Holy Symbol (Bishop, 4th Job)}>"
        ]
    },
    dHolyFountain: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/explorers/bishop/holy-fountain.png"],
        "type": "Summon Heal",
        ...
        "details": [
            ...
            "Does not stack with <tt src={http://localhost:3000/grandislibrary/class-icons/explorers/bishop/holy-fountain.png} tip={Holy Fountain (Bishop, 4th Job)}>"
        ]
    },
    erdaShower: {
        "name": "Erda Shower",
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/erda-shower-2.png", "http://localhost:3000/grandislibrary/class-icons/5th-job/erda-shower.png", "http://localhost:3000/grandislibrary/class-icons/5th-job/erda-fountain.png"],
        "type": "Attack/Summon",
        "desc": "The attack has two modes depending on the keys pressed",
        "details": [
            "<tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/erda-fountain.png} tip={Erda Fountain (5th Job)}> [Erda Shower] - Releases a surrounding area attack<bp_Can be activated by pressing the Skill Key_The cooldown is slightly reduced upon defeating an enemy_>",
            "<tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/erda-shower.png} tip={Erda Shower (5th Job)}> [Erda Fountain] - Places down a stationary summon that attacks whenever a fixed amount of enemies are defeated<bp_Can be activated by pressing the Down Arrow Key and Skill Key together_>",
            "Both skills share the same cooldown",
            "Right-clicking the skill will toggle a function ON/OFF that swaps the activation command for <tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/erda-fountain.png} tip={Erda Fountain (5th Job)}> and <tt src={http://localhost:3000/grandislibrary/class-icons/5th-job/erda-shower.png} tip={Erda Shower (5th Job)}>"
        ]
    },
    trueArachnidReflection: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/true-arachnid-reflection.png"],
        "type": "Summon",
    ...
    solarCrest: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/5th-job/solar-crest.png"],
        "type": "Summon",
...
export const commonSixth = {
    solJanus: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/6th-job/sol-janus.png"],
        "type": "Active",
        "desc": "When used, using the Arrow Keys, switch between <tt src={http://localhost:3000/grandislibrary/class-icons/6th-job/sol-janus-dusk.png} tip={Sol Janus: Dusk (6th Job)}> and <tt src={http://localhost:3000/grandislibrary/class-icons/6th-job/sol-janus-dawn.png} tip={Sol Janus: Dawn (6th Job)}>",
        "details": [
    ...
    solJanusDusk: {
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/6th-job/sol-janus-dusk.png"],
        "type": "Passive",
        ...
        "details": [
            ...
            "Shares the same Skill Points (SP) with <tt src={http://localhost:3000/grandislibrary/class-icons/6th-job/sol-janus.png} tip={Sol Janus: Dusk (6th Job)}> and Key Slot with <tt src={http://localhost:3000/grandislibrary/class-icons/6th-job/sol-janus-dawn.png} tip={Sol Janus: Dawn (6th Job)}>"
        ]
    },
    solJanusDawn: {
        "name": "Sol Janus: Dawn",
        ...
        "icons": ["http://localhost:3000/grandislibrary/class-icons/6th-job/sol-janus-dawn.png"],
        "type": "Summon",
        "desc": "Place down a stationary summon that damages nearby enemies",
        "details": [
            "Based on the Skill Level, up to 3 summons can be placed",
            "Unaffected by Damage Reflect",
            "Shares the same Skill Points (SP) with <tt src={http://localhost:3000/grandislibrary/class-icons/6th-job/sol-janus.png} tip={Sol Janus: Dusk (6th Job)}> and Key Slot with <tt src={http://localhost:3000/grandislibrary/class-icons/6th-job/sol-janus-dusk.png} tip={Sol Janus: Dusk (6th Job)}>"
        ]
    }
};
