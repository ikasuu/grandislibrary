...
function UpdateTimelineOverview() {
    return (
        <div>
            <ul>
                <li><Link to="#bang">Big Bang</Link></li>
                <li><Link to="#chaos">Chaos</Link></li>
                <li><Link to="#ascension">Ascension</Link></li>
                <li><Link to="#fellowship">Rise of Fellowship</Link></li>
                <li><Link to="#legends">Legends</Link></li>
                <li><Link to="#rising">Alliance Rising</Link></li>
                <li><Link to="#unbound">Alliance Unbound</Link></li>
                <li><Link to="#eternal">Alliance Eternal</Link></li>
                <li><Link to="#renegades">Renegades</Link></li>
                <li><Link to="#mutiny">Mutiny</Link></li>
                <li><Link to="#dawn">New Dawn</Link></li>
                <li><Link to="#champions">Champions</Link></li>
                <li><Link to="#tempest">Tempest</Link></li>
                <li><Link to="#snake">Year of the Snake</Link></li>
                <li><Link to="#honor">Mark of Honor</Link></li>
                <li><Link to="#hyper">Hyper Evolution</Link></li>
                <li><Link to="#unleashed">Unleashed</Link></li>
                <li><Link to="#reforged">Cygnus Knights Awakening</Link></li>
                <li><Link to="#dawnveil">Dawnveil Demons of Tynerum</Link></li>
                <li><Link to="#red">RED</Link></li>
                <li><Link to="#returnmasteria">Return to Masteria</Link></li>
                <li><Link to="#athenaeum">Grand Athenaeum</Link></li>
                <li><Link to="#legacynine">Legacy of Nine</Link></li>
                <li><Link to="#risingheroes">Rising Heroes: Elite</Link></li>
                <li><Link to="#hieizan">Mark of Honor: Hieizan</Link></li>
                <li><Link to="#sao">Sword Art Online</Link></li>
                <li><Link to="#awakening">Cygnus Awakening: Night Walker</Link></li>
                <li><Link to="#shiningstar">Shining Star</Link></li>
                <li><Link to="#titan">MapleStory x Attack On Titan</Link></li>
                <li><Link to="#blackheaven">Black Heaven</Link></li>
                <li><Link to="#springsummer">Spring Into Summer</Link></li>
                <li><Link to="#firepower">FIREPOWER</Link></li>
                <li><Link to="#superstar">Pink Bean: Superstar</Link></li>
                <li><Link to="#asylum">Asylum</Link></li>
                <li><Link to="#alishan">Welcome to Alishan</Link></li>
                <li><Link to="#reboot">Reboot</Link></li>
                <li><Link to="#masteriatime">Masteria Through Time</Link></li>
                <li><Link to="#eleven">Maple's Eleven</Link></li>
                <li><Link to="#detectives">Detectives</Link></li>
                <li><Link to="#heroesmaple">Heroes of Maple</Link></li>
                <li><Link to="#mushroomshrine">Mushroom Shrine Tales</Link></li>
                <li><Link to="#strangestories">Strange Stories</Link></li>
                <li><Link to="#v">V Update</Link></li>
                <li><Link to="#kerningcity">Kerning City Superstars</Link></li>
                <li><Link to="#rezero">MapleStory x Re:Zero</Link></li>
                <li><Link to="#override">Override: Evolve</Link></li>
                <li><Link to="#tuneup">Tune Up</Link></li>
                <li><Link to="#nova">Nova</Link></li>
                <li><Link to="#newyear">New Year Showdown</Link></li>
                <li><Link to="#evangelion">MapleStory x Evangelion</Link></li>
                <li><Link to="#pinkbeany">Lifestyle of the Pink Beany</Link></li>
                <li><Link to="#ark">Ark</Link></li>
                <li><Link to="#cardcaptor">MapleStory x Cardcaptor</Link></li>
                <li><Link to="#darknesslooms">Darkness Looms</Link></li>
                <li><Link to="#blackmage">Black Mage</Link></li>
                <li><Link to="#arcade">Arcade Adventures</Link></li>
                <li><Link to="#line">LINE FRIENDS x MapleStory</Link></li>
                <li><Link to="#pathfinder">Pathfinder</Link></li>
                <li><Link to="#worldsunite">Worlds Unite</Link></li>
                <li><Link to="#melody">Fabled Melody</Link></li>
                <li><Link to="#glory">Glory</Link></li>
                <li><Link to="#utopia">Mechanical Utopia</Link></li>
                <li><Link to="#isekai">MapleStory X ISEKAI QUARTET</Link></li>
                <li><Link to="#pixelparty">Pixel Party</Link></li>
                <li><Link to="#rise">Rise</Link></li>
