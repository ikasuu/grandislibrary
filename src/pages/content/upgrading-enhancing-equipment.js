...
function UpgradeEquipment() {
    return (
<div>
  <img className="irc_mi" src="https://vignette.wikia.nocookie.net/maplestory/images/4/46/Unlimited_UI_Equip.png/revision/latest?cb=20130426110647" alt="Image result for maplestory season 2 equipment" width={600} height={600} />
  Additional stats appear in <span style={{color: '#00ff00'}}>green</span> font while stats from upgrading appear in <span style={{color: '#33cccc'}}>blue</span> [Refer to 11]. The color of an item's name indicates how many stats above or below
  average an item is [Refer to 02]
  <h3 id="top">Quick Jumps</h3>
  <ul>
    <li><a href="#scrolls">Scrolls</a></li>
    <li><a href="#spelltrace">Spell Tracing</a></li>
    <li><a href="#starforce">Star Forcing</a></li>
    <li><a href="#hammer">Transfer Hammer</a></li>
    <li><a href="#transpose">Transposing</a></li>
    <li><a href="#cubing">Cubing</a></li>
    <li><a href="#additionalstats">Flames &amp; Additional Stats</a></li>
  </ul>
  <hr />
  ...
  <img src="https://maplestory.io/api/GMS/210.1.1/item/2046315/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/2046342/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/2046346/icon" /> <strong>[</strong>
  ...
  <ul>
    <li>
      <strong><img src="https://i.imgur.com/vOSAqit.png" /><img src="https://i.imgur.com/d0s1ZkB.png" /> [Magical Scroll]: </strong>Weapon scrolls that grant 9 to 11 Attack or Magic Attack +3 all stats
      <ul>
        <li>Obtainable from Gachapon</li>
      </ul>
    </li>
  </ul>
  <img className="wp-image-1056 aligncenter" src="https://grandislibrary.files.wordpress.com/2019/08/maplestory_kwobfqpqyt.png" alt="MapleStory_KWOBfqpQyT" width={273} height={164} />
  <ul>
    <li>
      <img src="https://maplestory.io/api/GMS/210.1.1/item/2612043/icon" /> <strong>[9th Anniversary Prime Scrolls]: </strong>Grants +3 all stats and Weapon Prime Scrolls provide +10 Attack and Magic Attack. Has a 40% chance to succeed
      and 30% to destroy item on failure
      <ul>
  ...
  <ul>
    <li>
      <img src="https://maplestory.io/api/GMS/210.1.1/item/2613050/icon" /> <strong>[X Scrolls]: </strong>Weapon scrolls that grant 10 to 12 Attack or Magic Attack and +5 all stats when applied. Has a 100% Success Rate
      <ul>
  ...
  <img className="size-full wp-image-1057 aligncenter" src="https://grandislibrary.files.wordpress.com/2019/08/maplestory_odassdq6eb.png" alt="MapleStory_OdasSDq6eB" width={346} height={138} />
  <ul>
    <li>
      <img src="https://maplestory.io/api/GMS/210.1.1/item/2046856/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/2046857/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/2048094/icon" />
  ...
  <img src="https://i.imgur.com/gr9M3UQ.png" /><img className src="https://i.imgur.com/0H8ab4l.png" width={276} height={407} />
  <ul>
    <li>
      <strong><img src="https://maplestory.io/api/GMS/210.1.1/item/2049300/icon" /> [Equip Enhancement Scroll]: </strong>These scrolls provides <strong>one star force</strong> (enhancement [1] , refer to image at top) on success
      <ul>
        <li>
    ...
    <li>
      <strong>
        <img src="https://maplestory.io/api/GMS/210.1.1/item/2049400/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/2049700/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/2049750/icon" />
        <img src="https://maplestory.io/api/GMS/210.1.1/item/2049784/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/2048305/icon" /> [Potential Scrolls]:
      </strong>
      These scrolls provide a <strong>potential for gear</strong>. When used, if an item does not have a potential, it will gain one on success. Or, there are certain ones that give <strong>Epic, Unique, and Legendary potential</strong>.
  ...
  <img className="size-full wp-image-1066 aligncenter" src="https://grandislibrary.files.wordpress.com/2019/08/maplestory_gkbu7gqpku.png" alt="MapleStory_GKbU7gQPku.png" width={287} height={329} />
  <ul>
    <li>
      <strong><img src="https://maplestory.io/api/GMS/210.1.1/item/2049370/icon" /> [Star Enhancement Scrolls]: </strong>These scrolls grant you a certain amount of <strong>star force/enhancements</strong> at a 100% rate
      <ul>
  ...
  <img className="size-full wp-image-1067 aligncenter" src="https://grandislibrary.files.wordpress.com/2019/08/maplestory_peknkv70n6.png" alt="MapleStory_pekNkv70n6.png" width={285} height={136} />
  <ul>
    <li>
      <strong><img src="https://maplestory.io/api/GMS/210.1.1/item/2049000/icon" /> [Clean Slate Scrolls]: </strong>These scrolls on success <strong>grants you back one upgrade slot</strong> on a failed upgrade
      <ul>
  ...
  <img className="size-full wp-image-1076 aligncenter" src="https://grandislibrary.files.wordpress.com/2019/08/maplestory_ftnmgfwmtw.png" alt="MapleStory_fTnMGFwmtw.png" width={284} height={136} />
  <ul>
    <li>
      <strong><img src="https://maplestory.io/api/GMS/210.1.1/item/2470000/icon" /> [Golden Hammers]: </strong>Golden Hammers provide <strong>extra upgrade slots</strong> on success but, if they fail you must use Clean Slates to get the
      slots back
      <ul>
    ...
    <li>
      <strong><img src="https://maplestory.io/api/GMS/210.1.1/item/2049100/icon" /> [Chaos Scrolls]</strong>: These scrolls provide a <strong>random amount of stats</strong> that can either give you more stats or fewer stats. These
  ...
  <img className="size-full wp-image-1070 alignnone" src="https://grandislibrary.files.wordpress.com/2019/08/maplestory_aau4ljbyrf.png" alt="MapleStory_aAu4lJbYrf.png" width={285} height={265} />
  <img className="alignnone" src="https://i.imgur.com/oQ8qc3P.png" />
  <ul>
    <li>
      <strong><img src="https://maplestory.io/api/GMS/210.1.1/item/2049600/icon" /> [Innocence Scrolls]:</strong> These scrolls completely <strong>reset an item except for its potential and additional stats</strong>
      <ul>
    ...
    <li>
      <strong>
        <img src="https://maplestory.io/api/GMS/210.1.1/item/2049500/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/2049501/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/2048336/icon" /> [Potential Stamps]:
      </strong>
      Some equipment may occasionally only come with two lines of potentials, potential stamps can <strong>add a third line on success</strong>
      <ul>
        <li>Can be found in Legion Shop, Event Shops and from <img src="https://maplestory.io/api/GMS/210.1.1/item/2431894/icon" /> Black Cube Fragments (obtained from using Black Cubes)</li>
      </ul>
    </li>
  </ul>
  <img src="https://i.imgur.com/hmN9qWG.png" /><img src="https://i.imgur.com/SLRQ2TC.png" />
  <ul>
    <li>
      <img src="https://maplestory.io/api/GMS/210.1.1/item/2720000/icon" /><img src="https://maplestory.io/api/GMS/210.1.1/item/5520001/icon" /> <strong>[</strong><strong>Karma Scissors]: </strong>Allows equipment that is untradable to be
      made tradable once
      <ul>
  ...
  <ul>
    ...
    <li>
      <strong><img src="https://maplestory.io/api/GMS/210.1.1/item/2532000/icon" /> <a href="https://maplestory.wiki/GMS/210.1.1/item/5064100">[Shield Scroll]</a>: </strong>Prevents the upgrade count of an item from decreasing on a scroll
      fail
    </li>
    <li>
    ...
    <li>
      <strong><img src="https://maplestory.io/api/GMS/210.1.1/item/5064400/icon" /> <a href="https://maplestory.wiki/GMS/210.1.1/item/5064400">[Return Scroll]</a>: </strong>Allows you to choose between the before and after effects of a
      scroll when applied
    </li>
  </ul>
  <hr />
  <a style={{color: '#03afe7'}} href="#top">Go to top</a>
  <h2 id="spelltrace"><img src="https://maplestory.io/api/GMS/210.1.1/item/2433943/icon" /> Spell Tracing in Regular Servers</h2>
  <hr />
  ...
  You can open the Equipment Enchant menu by either pressing "O" by default or through your inventory by pressing the <strong>red button with a hammer</strong>
  <img className="size-full wp-image-1079 aligncenter" src="https://grandislibrary.files.wordpress.com/2019/08/maplestory_fcrieeyovc.png" alt="MapleStory_fcRIEEyoVc.png" width={549} height={293} />
  Once you have opened the menu, you can drag a piece of equipment into it and start spell tracing. Spell tracing consumes a certain amount of spell traces to upgrade equipment. There are different scrolls to choose from, for weapons most of
  the time you just use the 70% ones and 15% if you have the resources and plan to keep it for a while For regular gear, you can upgrade them using 70% and 30% if you have the resources and plan to keep it for a while
  <strong>Note: The lower the success rate, the higher the stats they provide but also costs more Spell Traces! As well, the higher level gear will cost more Spell Traces</strong>
  <hr />
  <a style={{color: '#03afe7'}} href="#top">Go to top</a>
  <h2 id="starforce">Star Forcing</h2>
  <hr />
  <img src="https://support-maplestory.nexon.net/hc/article_attachments/360057675372/starforce.png" alt="starforce.png" />
  Once you have consumed all upgrade slots, you may star force/enhance your gear. In Reboot, there are no upgrade slots, so you just star force/enhance instead. Star Forcing costs mesos that grants increased stats on success.
  <img className="size-full wp-image-1077 alignnone" src="https://grandislibrary.files.wordpress.com/2019/08/maplestory_h5efp4vhek.png" alt="MapleStory_h5eFp4VHEk" width={212} height={110} />
  <img src="https://support-maplestory.nexon.net/hc/article_attachments/360057676032/equip_enchant.png" alt="equip_enchant.png" />
  <img className="size-full wp-image-1081 alignnone" src="https://grandislibrary.files.wordpress.com/2019/08/maplestory_bei6i280av.png" alt="MapleStory_bEi6i280av.png" width={335} height={290} />
  Like before, you can drag equipment into the Equipment Enchant UI like spell tracing to star force your gear
  <img src="https://support-maplestory.nexon.net/hc/article_attachments/360057676612/stop.png" alt="stop.png" /><img src="https://support-maplestory.nexon.net/hc/article_attachments/360057832451/successenchant.png" alt="successenchant.png" />
  Once you press "Enhance", a window/mini game will pop up, you will need to press "Stop" in the middle to increase your success rate by a VERY small amount. You can disable the mini game by pressing "Disable Star Catching". Another button
  you see is "Safeguard" which protects your item from being destroyed but increases the cost significantly Higher level equipment will have more available stars/enhancements but they are also more expensive to enhance but they provide more
  stats the more you enhance it. The optimal amount of stars you want for each piece of equipment is 10-12 stars early game
  <h3><strong>Star Force Outcomes</strong></h3>
  There are four possible outcomes when Star Forcing. The success and failure rates scale with the current Star Force level of the equipment
  <table>
    <tbody>
      <tr>
      ...
      <tr>
        <td><strong>Failure (Keep)</strong></td>
        <td>No change to Star Force level</td>
      </tr>
      <tr>
        <td><strong>Failure (Drop)</strong></td>
        <td>Decrease Star Force level by 1</td>
      </tr>
      <tr>
        <td><strong>Failure (Destroy) </strong></td>
        <td>Destroy equipment and create Equipment Trace</td>
      </tr>
    </tbody>
  </table>
  <br />
  If two Star Force attempts in a row result in failure, the next attempt will enter Chance Time and have a guaranteed success rate. Additionally, once a piece of equipment reaches 10, 15 and 20 Star Force respectively, they will not drop
  below that Star Force even if the attempt fails If the equipment is destroyed while Star Forcing, you will gain an Equipment Trace. Equipment Traces can be applied to a new copy of the same item to restore all the stats, potentials and
  enhancements
  <strong>[Star Force Maps]</strong> There are special training maps that will require you to have a certain amount of Star Force to hunt efficiently on a map. These maps feature monsters with greater health but give much more EXP Star Force
  also contributes to the amount of damage your Legion Character does on the Legion Board
  <hr />
  <a style={{color: '#03afe7'}} href="#top">Go to top</a>
  <h2 id="hammer">Transfer Hammer</h2>
  <hr />
  <img src="https://i.imgur.com/W6T3Q8C.png" />
  <p>
    Transfer Hammer is a system that allows you to transfer Star Force, Potentials, Bonus Potentials, and Soul Weapon from one equipment to another (with restrictions). The following will not be transferred, Scrolled Stats and Additional
    Stats. Additionally you will lose one Star Force while transferring and any potentials above Epic will be dropped down to Epic Potential. You can only transfer equipment up to 10 levels apart of each other. For equipment below Lv. 100,
    you can transfer up to 20 levels apart
  </p>
  <p>
    Some requirements for Transfer Hammering is that the piece of equipment must have at least 1 Star Force, cannot be Superior Gear (such as Tyrants) and must be the same equipment type (regardless of job group). Overalls can be counted
    towards both as a top or bottom and vice versa
  </p>
  <p>
    In regular servers, any remaining upgrade slots will be filled by 100% Spell Traces for free. You can choose which stat you want the upgrades to be. I recommend that you already Upgrade/Spell Trace the Transferring Item first if you do
    not want the 100% Spell Trace stats
  </p>
  ...
  <hr />
  <img src="https://puu.sh/FReKh/e8c6cc90b1.png" />
  ...
  <hr />
  <img src="https://i.imgur.com/KiRDRYi.png" /><img src="https://i.imgur.com/qQkJRO6.png" />
  Cubing refers to using Cubes that will reroll the Potential of an item. Cubes may tier up your equipment's Potential to the next rank, up to what that cube will allow. Equipment can also have Bonus Potentials as well that add upon your
  regular Potentials To start Cubing, double-click on a Cube in your inventory (USE or CASH tab) and then drag the Cube onto the piece of Equipment you want to reroll
  <img src="https://i.imgur.com/uaD0QPP.png" />
  You can reveal a piece of equipment's Potential by pressing the <strong>blue button with a magnifying glass </strong>
  ...
  <img src="https://maplestory.io/api/GMS/210.1.1/item/2432268/icon" /> <strong><a href="https://maplestory.wiki/GMS/210.1.1/item/5062009">[Red Cube]</a>: </strong>Rerolls potential of items up to LEGENDARY
  <ul>
    <li style={{listStyleType: 'none'}}>
      <ul>
  ...
  <hr />
  <a style={{color: '#03afe7'}} href="#top">Go to top</a>
  <h2 id="additionalstats">Flames &amp; Additional Stats</h2>
  <hr />
  Equipment can come with additional stats. The stats can be categorized into Tiers. There are a total of 7 tiers with 7 being the highest and providing the most stat boosts. Boss Equipment &amp; KMS equipment tends to have higher tiers of
  additional stats compared to items outside of KMS (for example Gollux accessories &amp; Sweetwater). More info can be found at the bottom of the page on Additional Stats To reroll Additional Stats, you need to use items called "Rebirth Flames".
  Regular rebirth flames that have a "LV. X" attached to it can only reroll certain items up to that specified level and are dropped by Bosses. These regular flames yield lower tiers compared to special ones. You can identify which equipment
  can be flamed by hovering over them and checking the top left corner of the equipment icon. If there is a transparent dot, it can be flamed with regular rebirth flames. If there is a white dot, it can only be flamed with special rebirth
  flames
  ...
  <hr />
  On the top left corner of an equipment icon when hovering over it, there is a dot that indicates if a Regular Rebirth Flame can be applied to that equipment
  <img src="https://i.imgur.com/sqgQgFz.png" alt="" />
  <ul>
    <li>Transparent dot: Can be flamed with all Rebirth Flames</li>
  </ul>
  <img src="https://i.imgur.com/WZsmvAt.png" alt="" />
  <ul>
    <li>White dot: Can only be flamed with Powerful Rebirth Flames and Eternal Rebirth Flames</li>
  </ul>
  <hr />
