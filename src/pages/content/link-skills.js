...
function LinkSkills() {
    return (
      <div className="repository-md-container">
        <p><img src="https://i.imgur.com/MuIiQA4.png" alt="Link Manager UI"/></p>
        ...
        <p><img src="https://i.imgur.com/waEl3bv.png" alt="Link Manager Skill"/></p>
        ...
        <ul>
          <li><Link smooth to="#explorers" scroll={el => scrollWidthOffset(el)}>Explorers</Link></li>
          <li><Link smooth to="#cygnusknights" scroll={el => scrollWidthOffset(el)}>Cygnus Knights</Link></li>
          <li><Link smooth to="#heroes" scroll={el => scrollWidthOffset(el)}>Heroes</Link></li>
          <li><Link smooth to="#resistance" scroll={el => scrollWidthOffset(el)}>Resistance</Link></li>
          <li><Link smooth to="#nova" scroll={el => scrollWidthOffset(el)}>Nova</Link></li>
          <li><Link smooth to="#sengoku" scroll={el => scrollWidthOffset(el)}>Sengoku</Link></li>
          <li><Link smooth to="#flora" scroll={el => scrollWidthOffset(el)}>Flora</Link></li>
          <li><Link smooth to="#other" scroll={el => scrollWidthOffset(el)}>Other</Link></li>
          <li><Link smooth to="#notable" scroll={el => scrollWidthOffset(el)}>Notable Link Skills</Link></li>
          <li><Link smooth to="#builds" scroll={el => scrollWidthOffset(el)}>Examples of Link Skill Builds</Link></li>
        </ul>
        <hr />
